                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="page"  data-parent="#topAccordion">
                            ...
                            <li class="sub-sub-submenu-list">
                                <a href="/customers" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Employees <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                <ul class="collapse list-unstyled sub-submenu" id="pages-error" data-parent="#more">
                                    <li>
                            ...
                            <li class="sub-sub-submenu-list">
                                <a href="/customers" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Departments <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                <ul class="collapse list-unstyled sub-submenu" id="pages-error" data-parent="#more">
                                    <li>
                                        <a href="/departments"> Depatment List </a>
                                    </li>
                                    <li>
                                        <a href="/departments/create"> New Department </a>
                                    </li>

                                </ul>
                            </li>
                            <li class="sub-sub-submenu-list">
                                <a href="/customers" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Tickets <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                <ul class="collapse list-unstyled sub-submenu" id="pages-error" data-parent="#more">
                                    <li>
                                        <a href="/tickets"> Tickets List </a>
                                    </li>
                                    <li>
                            ...
                            <li class="sub-sub-submenu-list">
                                <a href="/customers" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Statuses <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                <ul class="collapse list-unstyled sub-submenu" id="pages-error" data-parent="#more">
                                    <li>
                                        <a href="/statuses"> Statuses List </a>
                                    </li>
                                    <li>
